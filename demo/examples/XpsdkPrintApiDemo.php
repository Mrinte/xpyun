...
EOF;
     ...
     * 80mm打印机一行可打印机48个字符
     */
    function printComplexReceipt80()
    {
        /**
         * <BR>：换行符（同一行有闭合标签(如 </C>)则应放到闭合标签前面, 连续两个换行符<BR><BR>可以表示加一空行）
         *  <L></L>：左对齐
        ...
        $printContent = $printContent . "菜名" . str_repeat(" ", NoteFormatter::MAX_HEAD_NAME_CHAR_LEN80) . "数量" . str_repeat(" ", 2) . "单价" . str_repeat(" ", 2)
            . "<BR>";
        $printContent = $printContent . str_repeat("-", NoteFormatter::ROW_MAX_CHAR_LEN80) . "<BR>";
        $printContent = $printContent . NoteFormatter::formatPrintOrderItem80("可乐鸡翅", 2, 9.99);
        $printContent = $printContent . NoteFormatter::formatPrintOrderItem80("水煮鱼特辣水煮鱼特辣水煮鱼特辣水煮鱼特辣水煮鱼特辣", 1, 108.0);
        $printContent = $printContent . NoteFormatter::formatPrintOrderItem80("豪华版超级无敌龙虾炒饭豪华版超级无敌龙虾炒饭豪华版超级无敌龙虾炒饭", 1, 99.9);
        $printContent = $printContent . NoteFormatter::formatPrintOrderItem80("炭烤鳕鱼炭烤鳕鱼炭烤鳕鱼", 5, 19.99);
        $printContent = $printContent . NoteFormatter::formatPrintOrderItem80("Grilled cod with charcoal", 5, 19.99);
        $printContent = $printContent . NoteFormatter::formatPrintOrderItem80("炭烤鳕鱼(Grilled cod with charcoal)", 5, 19.99);
        $printContent = $printContent . str_repeat("-", NoteFormatter::ROW_MAX_CHAR_LEN80) . "<BR>";
...
//        print $result->content->data . "\n";
     ...
     * 80mm打印机一行可打印机48个字符
     */
    function printComplexReceipt58()
    {
        /**
         * <BR>：换行符（同一行有闭合标签(如 </C>)则应放到闭合标签前面, 连续两个换行符<BR><BR>可以表示加一空行）
         *  <L></L>：左对齐
        ...
        $printContent = $printContent . "菜名" . str_repeat(" ", NoteFormatter::MAX_HEAD_NAME_CHAR_LEN58) . "数量" . str_repeat(" ", 2) . "单价" . str_repeat(" ", 2)
            . "<BR>";
        ...
        $printContent = $printContent . NoteFormatter::formatPrintOrderItem("水煮鱼特辣水煮鱼特辣水煮鱼特辣水煮鱼特辣水煮鱼特辣", 1, 108.0);
        $printContent = $printContent . NoteFormatter::formatPrintOrderItem("豪华版超级无敌龙虾炒饭豪华版超级无敌龙虾炒饭豪华版超级无敌龙虾炒饭", 1, 99.9);
        $printContent = $printContent . NoteFormatter::formatPrintOrderItem("炭烤鳕鱼炭烤鳕鱼炭烤鳕鱼", 5, 19.99);
        $printContent = $printContent . NoteFormatter::formatPrintOrderItem("Grilled cod with charcoal", 5, 19.99);
        $printContent = $printContent . NoteFormatter::formatPrintOrderItem("炭烤鳕鱼(Grilled cod with charcoal)", 5, 19.99);
        $printContent = $printContent . str_repeat("-", NoteFormatter::ROW_MAX_CHAR_LEN) . "<BR>";
        $printContent = $printContent . "<R>" . "合计：" . "327.83" . "元" . "<BR></R>";
